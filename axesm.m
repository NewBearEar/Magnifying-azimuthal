...
switch propname
	...
	%-------------自定义参数的赋值-------------
	case 'rngz1'
        mstruct = setRngz1(mstruct,propvalu);

    case 'zoom_factor'
        mstruct = setZoomFactor(mstruct, propvalu);
		
	case 'phi00'
        mstruct = setPhi00(mstruct,propvalu);

    case 'lambda00'
        mstruct = setLambda00(mstruct, propvalu);
	%---------------------------------------------------
...
%-----------------------------------------------------------------------
%自定义setter函数
function mstruct = setRngz1(mstruct, rngz1)
mstruct.rngz1 = rngz1;

function mstruct = setZoomFactor(mstruct, zoom_factor)
mstruct.zoom_factor = zoom_factor;

function mstruct = setPhi00(mstruct, phi00)
mstruct.phi00 = phi00;

function mstruct = setLambda00(mstruct, lambda00)
mstruct.lambda00 = lambda00;
