...
%
%   list.IdString defines the name of the Mapping Toolbox projection
%   function.
%
...
% if a new projection was added, then a new entry in the list structure
% would be:
%
%      i=i+1;
%      list.Name(i)           = 'My Projection'
%      list.IdString(i)       = 'newprojection';
%      list.Classification(i) = 'New Projection Type';
%      list.ClassCode(i)      = 'Code';
...
i=i+1;
list(i).IdString       = 'cassinistd';
list(i).Classification = 'Cylindrical';
list(i).Name           = 'Cassini Cylindrical-Standard';
list(i).ClassCode      = 'Tran';
...
i=i+1;
list(i).IdString       = 'eqaconicstd';
list(i).Classification = 'Conic';
list(i).Name           = 'Equal Area Conic (Albers)-Standard';
list(i).ClassCode      = 'Cstd';
...
i=i+1;
list(i).IdString       = 'eqdconicstd';
list(i).Classification = 'Conic';
list(i).Name           = 'Equidistant Conic-Standard';
list(i).ClassCode      = 'Cstd';
...
i=i+1;
list(i).IdString       = 'lambertstd';
list(i).Classification = 'Conic';
list(i).Name           = 'Lambert Conformal Conic-Standard';
list(i).ClassCode      = 'Cstd';
...
i=i+1;
list(i).IdString       = 'polyconstd';
list(i).Classification = 'PolyConic';
list(i).Name           = 'Polyconic-Standard';
list(i).ClassCode      = 'Pstd';
...
i=i+1;
list(i).IdString       = 'variable_ortho';
list(i).Classification = 'Azimuthal';
list(i).Name           = 'Variable_Orthographic*';
list(i).ClassCode      = 'Azim';
